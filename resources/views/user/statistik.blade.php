...
@section('content')
    ...
    <div id="main-content" class="max-w-6xl mx-auto space-y-10 hidden">
        ...
        {{-- ✨ Motivation Carousel Section — Premium Redesign --}}
        ...
        <div class="motivation-carousel-wrapper relative group/carousel animate-slide-up" id="motivationCarousel">
            ...
            <div class="absolute -inset-[1px] bg-gradient-to-r from-amber-400 via-orange-500 to-rose-500 rounded-[2.5rem] opacity-20 group-hover/carousel:opacity-40 transition-opacity duration-500 blur-sm"></div>

            <div class="relative card-premium rounded-[2.5rem] overflow-hidden">
                {{-- Header --}}
                <div class="flex items-center justify-between px-8 pt-8 pb-4 md:px-10 md:pt-10">
                    <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-1.5">
                        <span class="text-[10px] font-black text-slate-300 dark:text-slate-600 tabular-nums" id="slideCounter">
                ...
                {{-- Slides Container --}}
                <div class="relative overflow-hidden" style="min-height: 260px;" id="slidesContainer">
                    ...
                    <div class="motivation-slide absolute inset-0 transition-all duration-600 ease-in-out {{ $index === 0 ? 'opacity-100 translate-x-0 visible' : 'opacity-0 translate-x-8 invisible' }}"
                        ...
                        @if($item->tipe == 'image' && $item->foto)
                            {{-- Image Motivasi --}}
                            <div class="px-8 pb-4 md:px-10 h-full">
                                <div class="relative rounded-2xl overflow-hidden h-[220px] md:h-[240px] group/img">
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                                        <p class="text-white text-lg md:text-xl font-bold leading-relaxed drop-shadow-lg line-clamp-3">
                                            "{{ $item->isi }}"
                                        </p>
                                    </div>
                                    @endif
                        ...
                        @else
                            {{-- Text Motivasi --}}
                            <div class="flex items-center justify-center h-full px-8 md:px-10 pb-4">
                                <div class="max-w-2xl text-center py-4">
                                    <div class="relative inline-block">
                                        ...
                                        <p dir="auto" class="text-xl md:text-2xl lg:text-3xl font-bold text-slate-700 dark:text-slate-200 leading-relaxed relative z-10 px-6" style="font-family: 'Amiri', 'Traditional Arabic', 'Arabic Typesetting', 'Plus Jakarta Sans', sans-serif; line-height: 1.8;">
                                            {{ $item->isi }}
                                        </p>
                ...
                {{-- Bottom Navigation --}}
                @if($motivasi->count() > 1)
                <div class="flex items-center justify-between px-8 pb-6 md:px-10 md:pb-8">
                    {{-- Prev Button --}}
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateSlide(newIndex, direction = 'next') {
                ...
                // Prepare incoming slide position, then animate in
